...
class ArrayWrapper {
    private:
        ...
        ARR * arr_mov;
        int size;
        int checkVal(int iterator, ARR randVal) {
    ...
    public:
        ArrayWrapper(ARR * arr, int length) {
            srand(time(NULL));
            arr_mov = arr;
            this->size = length;
        }
        ArrayWrapper(ARR * arr, int length, ARR clear) {
            srand(time(NULL));
            arr_mov = arr;
            this->size = length;
...
int main(void) {
    ...
    char *array_two = new char[10];
    ArrayWrapper<int> test(array, 10, 0);
    ArrayWrapper<char> arr_char(array_two, 10, 'b');
